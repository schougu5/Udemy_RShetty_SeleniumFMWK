...
public class ReuseCode_ExcelUploadDownloadTest extends BaseTest {
    ...
    public void uploadExcelFile() {
       ...
       // By ToastByMsg = By.cssSelector(".Toastify__toast-body div:nth-child(2");
       
        
       WebElement ToastMessage = driver.findElement(By.cssSelector(".Toastify__toast-body div:nth-child(2"));
      
       AbstractComponent abstractComponent = new AbstractComponent(driver);
       abstractComponent.WebElementArgumentWaitforElementToAppear(ToastMessage);

       
       
       String Text_ofToastMessage = ToastMessage.getText();
       Assert.assertEquals(Text_ofToastMessage, "Updated Excel Data Successfully.");
